      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-10">
          ...
          <div className="w-full lg:w-1/2 space-y-6 text-center text-[#38393a]">
            <p>
              Na Europhear, nossa missão é clara e inabalável: proporcionar a todos uma vida plena e conectada por meio da audição.
            </p>
            <p>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600">
            Veja como é simples adquirir, ajustar e aproveitar o seu aparelho auditivo Europhear.
          </p>
        </div>
