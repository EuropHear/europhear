...
export default function Rastreio() {
  ...
  useEffect(() => {
    ...
    const renderWidget = () => {
      ...
      target.innerHTML = "";
      ordertracker({ id: "693021b80b762b36da320cd9" }).render(selector);
    };

    let script = document.getElementById(ORDERTRACKER_SCRIPT_ID) as HTMLScriptElement | null;
    ...
    <main className="min-h-screen bg-[#f3fbfc]">
      <div className="max-w-5xl mx-auto px-4 py-16 space-y-10">
        <div className="text-center space-y-3">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">{r.p}</p>
        </div>
