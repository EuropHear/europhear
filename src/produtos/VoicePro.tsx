...
export default function VoicePro() {
  ...
  const dados = {
    sigla: 'VoicePro | Europhear',
    nome: 'VoicePro Profissional Digital | Europhear',
    descricao:
  ...
  const destaquesRapidos = [
    ...
    },
    {
      ...
      descricao: 'Comunidade Europhear aprovando o VoicePro em todo o país.'
    },
    {
  ...
  return (
    <section className="pt-20 md:pt-24 min-h-screen hero-bg grid-bg font-[Inter] text-white">
      ...
      <section className="w-full section-gradient py-12 px-4 text-base lg:text-lg">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-semibold text-white mb-6">{t.product.whyChoose} o VoicePro?</h2>
