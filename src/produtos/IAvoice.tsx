...
export default function IAvoice() {
  ...
  const dados = {
    sigla: 'IAvoice | Europhear',
    nome: 'IAvoice Inteligência Auditiva | Europhear',
    descricao:
    ...
    avaliacoes: 51,
    nota: 4.6,
    link: 'https://europhearltda.pay.yampi.com.br/r/ECWQAEC09P'
  }
  ...
  const videos = [
    ...
    },
    {
      ...
      descricao: 'Depoimentos de quem j recuperou a audio com a Europhear.',
    ...
    <section className="pt-20 md:pt-24 min-h-screen hero-bg grid-bg font-[Inter] text-white">
      ...
      <section className="w-full bg-white/5 py-12 px-4 text-base lg:text-lg">
        <div className="max-w-5xl mx-auto grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border border-[#028794]/20 bg-white/5 p-6">
            <h3 className="text-xl font-semibold mb-4 text-[#7de8ff]">?? {t.product.boxContents}</h3>
            <ul className="space-y-3 text-gray-300">
      ...
      <section className="w-full section-gradient py-12 px-4 text-base lg:text-lg">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-300 mb-8 max-w-3xl mx-auto">
            Conheça nossa estrutura e oua relatos reais de quem j transformou a audio com a Europhear.
          </p>
